...
if(PKG_CONFIG_EXECUTABLE)
  find_package(dash 1.0)
  if((NOT dash_FOUND) AND (NOT DASH_FOUND))
    pkg_check_modules(dash dash>=1.0)
  endif()
  if((NOT dash_FOUND) AND (NOT DASH_FOUND))
    message(FATAL_ERROR "Could not find dash")
  endif()
else()
  find_package(dash 1.0  REQUIRED)
endif()
