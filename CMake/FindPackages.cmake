...
common_package(Boost 1.41.0  REQUIRED COMPONENTS program_options serialization system thread date_time)
...
if(Boost_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND CODASH_DEPENDENT_LIBRARIES Boost)
  endif()
...
if(dash_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND CODASH_DEPENDENT_LIBRARIES dash)
  endif()
...
if(Collage_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND CODASH_DEPENDENT_LIBRARIES Collage)
  endif()
...
if(Lunchbox_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND CODASH_DEPENDENT_LIBRARIES Lunchbox)
  endif()
