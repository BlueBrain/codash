...
#   define CODASH_VERSION_LE( MAJOR, MINOR, PATCH )                         \
    ...
    {
    public:
        /** @return the current major version of CoDASH. @version 0.4 */
        static uint32_t getMajor();

        /** @return the current minor version of CoDASH. @version 0.4 */
        static uint32_t getMinor();

        /** @return the current patch level of CoDASH. @version 0.4 */
        static uint32_t getPatch();

        /** @return the current revision of CoDASH. @version 0.4 */
        static std::string getRevision();

        /** @return the current DSO binary revision. @version 0.4 */
        static uint32_t getABI();

        /** @return the current CoDASH version (MMmmpp). @version 0.4 */
        static uint32_t getInt();

        /** @return the current CoDASH version (MM.mmpp). @version 0.4 */
